...
//        {
//            if (Aimbot.Enabled && Aimbot.SilentAim && Global.Locked != null)
//            {
//                Vector3 normal = (Global.GetAimPosition(Global.Locked.transform, "Skull") - Player.player.look.aim.position).normalized;
